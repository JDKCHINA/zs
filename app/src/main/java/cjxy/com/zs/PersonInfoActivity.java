...
public class PersonInfoActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		Button goSecondActivityButton = (Button) findViewById(R.id.button3);
		Button goOneActivityButton = (Button) findViewById(R.id.button1);
		Button goThreeActivityButton = (Button) findViewById(R.id.button2);
